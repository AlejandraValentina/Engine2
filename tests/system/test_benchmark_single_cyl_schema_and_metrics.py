...
@pytest.mark.system
def test_benchmark_single_cyl_schema_and_metrics(tmp_path: Path) -> None:
    engine = Path("validation_cases/single_cyl_moto_like.json").resolve()
    dataset = Path("benchmarks/datasets/single_cyl_moto_na").resolve()
