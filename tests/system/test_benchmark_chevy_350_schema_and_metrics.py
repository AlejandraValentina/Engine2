...
@pytest.mark.system
def test_benchmark_chevy_350_schema_and_metrics(tmp_path: Path) -> None:
    engine = Path("presets/chevy_350.json").resolve()
    dataset = Path("benchmarks/datasets/chevy_350_na").resolve()
