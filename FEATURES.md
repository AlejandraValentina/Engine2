...
- [x] Validacion externa con dataset minimo + contrato de error — Evidencia: `pywavedyn/bench.py`, `benchmarks/`, `schemas/bench_report.schema.json`, `tests/integration/test_benchmark_report_schema_and_error_contract.py`. Run: `python -m pywavedyn.cli benchmark --engine presets/honda_k20.json --dataset benchmarks/datasets/honda_k20_na --out bench_report.json`.
